...
class TestCheckpointUtils:
    ...
    def test_inspect_checkpoint_no_file(
        self, mock_exists, mock_checkpoint_manager
    ):
    ...
    @patch("utilities.checkpoint_utils.CheckpointManager")
    @patch("utilities.checkpoint_utils.os.path.exists")
    def test_inspect_checkpoint_with_file(
        self, mock_exists, mock_checkpoint_manager
    ):
    ...
    def test_clear_checkpoint_with_confirmation(
        self, mock_input, mock_remove, mock_exists, mock_checkpoint_manager
    ):
        ...
        mock_manager = Mock()
        mock_manager.checkpoint_file = os.path.join(
    ...
    @patch("utilities.checkpoint_utils.CheckpointManager")
    @patch("utilities.checkpoint_utils.os.path.exists")
    def test_clear_checkpoint_no_file(
        self, mock_exists, mock_checkpoint_manager
    ):
