...
general = {
    ...
    "random_seed": 42,  # set to -1 for random seed based on system time
}
...
afterburner_toolkit = {
    ...
    "order_max": 6,  # the maximum harmonic order (= order_max - 1 ) of anisotropic flow
    ...
    "npT": 40,  # number of pT points for pT-differential spectra and vn
    "pT_min": 0.00,  # the minimum value of transverse momentum (GeV)
    "pT_max": 4.00,  # the maximum value of transverse momentum (GeV)
    ...
    "tau_reject": 10.0,  # reject decay particle whose tau_f > tau_reject
